...
const SchoolLayout = () => {
    ...
    // --- 📝 FULL FEATURE LIST (Sidebar Menu) ---
    const menuItems = [
        ...
        { path: '/school/inventory', name: 'Inventory', icon: <Layers size={20} /> },
            ...
            <div className="flex-1 flex flex-col w-full min-w-0">
                ...
                <header className="h-16 bg-white border-b border-gray-200 flex justify-between items-center px-4 md:px-6 shadow-sm z-10 sticky top-0 flex-shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <img
                            src={`https://ui-avatars.com/api/?name=${theme.name}&background=random`}
                            className="w-9 h-9 rounded-full border-2 p-0.5"
